...
az appservice web config appsettings update -s dev --setting API_ENDPOINT=http://${server_prefix}-api-nodejs-dev.azurewebsites.net -g $paas_rg -n $server_prefix-web-nodejs
